...
const gl = __gl; // _gl save the orignal gl functions.
...
function attachMethodOpt() {
  ...
  gl.viewport = viewportOpt; // extensions
...
},{"./Blob":3,"./base64/base64.min":4,"./glOptMode":5,"./jsb-adapter":30,"./jsb_audioengine":35,"./jsb_input":36,"./jsb_opengl":37,"./jsb_prepare":39,"./promise.min":40,"./xmldom/dom-parser":41}],7:[function(require,module,exports){
"use strict";
...
function mouseEventHandlerFactory(type) {
  return event => {
    ...
    const mouseEvent = new MouseEvent(type, {
      button: button,
      which: button + 1,
      wheelDelta: event.wheelDeltaY * 120,
...
},{"./DOMRect":7,"./HTMLElement":16,"./ImageData":22}],16:[function(require,module,exports){
"use strict";
...
},{"timers":2}],41:[function(require,module,exports){
"use strict";
...
},{"./dom":42,"./entities":43,"./sax":44}],42:[function(require,module,exports){
"use strict";
